...
households_subset.to_hdf(arc_h5_file, 'households', mode='a')
...
hhids = households_subset['HHID']
persons_chunk = persons.loc[persons['HHID'].isin(hhids)]
persons_subset = persons_chunk.sample(n=25)
#print(persons_subset)
persons_subset.to_hdf(arc_h5_file, 'persons', mode='a')
